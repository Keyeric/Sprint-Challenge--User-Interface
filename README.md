...
Semantic HTML is terms used to markup html to better describe  and format code

2. Name two big differences between ```display: block;``` and ```display: inline;```.

An inline element does not cause a line break nor use the full page width while a block element does both.
...
Cross axis, which is the vertical axis.

5. Explain why git is valuable to a team of developers.

Git is an invaluable tool for dev teams because it lets the work on the same file at the same time.
